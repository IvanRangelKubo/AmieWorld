<!DOCTYPE html>
<html data-wf-page="6887a744c366a2ae40132ca6" data-wf-site="6887a73ec366a2ae40132b42" xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" lang="{% for language in languages %}{% if language.active %}{{ language.lang }}{% endif %}{% endfor %}">
    <head>
    ...
    <body class="{% if settings.head_fix %}js-head-offset head-offset{% endif %} {% if customer %}customer-logged-in{% endif %} template-{{ template | replace('.', '-') }}">
        ...
        <script>
            ...
            991:{
               ...
               {# Custom JS file #}
        <script src="{{ 'js/core.js' | static_url }}"></script>
